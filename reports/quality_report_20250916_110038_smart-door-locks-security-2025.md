...
**文章路径**: D:\Users\claude\quality-detection-tool\articles\smart-door-locks-security-2025.md
...
3. {'type': 'title_length', 'issue': '标题长度 71 字符，超过建议长度', 'suggestion': '建议缩短到50-60字符，保持关键词但提高可读性', 'current_value': 'Smart Door Locks Security 2025: Complete Guide to Keyless Entry Systems', 'recommended_action': '重写标题，保留主要关键词'}
