...
**文章文件**: smart-door-locks-security-2025.md
**文章路径**: D:\Users\Fzero\project\ai-smarthome\quality-detection-tool\articles\smart-door-locks-security-2025.md
...
### ✅ 已自动修复
1. 生成标准slug: smart-door-locks-security-2025-complete

### ⚠️ 需要人工确认
1. 未识别的分类 'smart-security'，请确认是否正确
2. 未识别的分类 'home-automation'，请确认是否正确
3. 标题长度 71 字符，建议50-60字符
...
// 建议修复为：
![smart door locks 2025产品主图详细介绍](/images/products/smart-plugs/amazon-smart-plug.jpg)
```
- **建议理由**: 基于keyword_based策略生成
- **文本长度**: 29字符 (建议50-125字符)
...
**修复说明:**
- 生成标准slug: smart-door-locks-security-2025-complete
